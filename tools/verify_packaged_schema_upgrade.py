...
def _build_candidate_isolation_environment(data_dir: Path) -> dict[str, str]:
    ...
    webview_data_dir = resolved_data_dir / "webview2-user-data"
...
def _start_candidate(
    ...
    port = _free_port()
    environment = _build_candidate_isolation_environment(data_dir)
...
def verify_candidate(sidecar_dir: Path) -> dict[str, Any]:
    ...
    required_sources = {
        ...
        "python/model_router.py": "smart model routing policy",
        "python/model_candidate_validation.py": "model candidate validation evidence",
        "python/model_candidate_canary.py": "model candidate Provider evidence",
