...
class CanvasLedgerTests(unittest.TestCase):
    ...
    def test_schema_v4_has_immutable_canvas_versions_and_job_bindings(self) -> None:
...
class CanvasMigrationTests(unittest.TestCase):
    ...
    def test_v3_upgrade_creates_v4_and_a_queryable_v3_backup(self) -> None:
        create_v3_database(self.db_path)
        ledger = AtelierLedger(self.db_path)
        self.assertEqual(ledger.stats()["schema_version"], 4)
