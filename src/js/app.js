...
function bindEvents() {
  ...
  $('#btn-review-summary-suggestion').addEventListener('click', (event) => {
    knowledgeController.openSuggestion(event.currentTarget.dataset.suggestionId || '');
  });
  ...
  $('#btn-feedback-suggestion').addEventListener('click', () => {
    knowledgeController.openSuggestion(state.feedbackSuggestionId || $('#btn-feedback-suggestion').dataset.suggestionId);
  });
  $('#btn-result-next').addEventListener('click', completeCurrentWorkspace);
  sessionsController.bind();
  knowledgeController.bind();
